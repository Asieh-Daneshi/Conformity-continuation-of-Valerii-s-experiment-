...
df_FollowPercentage = np.empty([len(FollowPercentageLong),3])
...
df_FollowPercentage[:,0] = congruency[:,0]
df_FollowPercentage[:,1] = num_agents[:,0]
df_FollowPercentage[:,2] = FollowPercentageLong[:,0]
